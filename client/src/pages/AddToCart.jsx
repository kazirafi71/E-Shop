          ...
          {cart.view_cart && (
            <div className="col-md-8 mt-5">
              <Container>
                <Paper className="">
                  <div className="mb-4">
                    <Typography className='py-4 m-auto text-center' variant="h6">
                        ...
                        <Paper className="mb-3 p-2 ">
                          <div className="view__cart">
                            ...
                            <div className="w-100">
                              ...
                              <Typography className="mr-1" variant='subtitle1'>Quantity: </Typography>
                              {
                                val.quantity<=0 ?
                                <Button
                                 className='disabled'   disabled variant="contained">
                                <MinimizeIcon />
                              </Button> : 
                               <Button  onClick={()=>removeQuantity(val.product._id)}  variant="contained">
                               <MinimizeIcon />
                             </Button>

                              }
                             
                              <Typography variant='subtitle1' className="mx-1">{val.quantity}</Typography>
                              {
